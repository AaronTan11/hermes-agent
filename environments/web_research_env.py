...
Inspired by: GroceryMind — production Rhemify agent doing live web research
             across German grocery stores (firecrawl + rhemify)
"""
...
class WebResearchEnvConfig(RhemifyAgentEnvConfig):
...
class WebResearchEnv(RhemifyAgentBaseEnv):
    """
