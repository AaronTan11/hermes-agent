...
Training tasks (3):
    1. Create ~/greeting.txt with "Hello from Rhemify"
...
TRAIN_TASKS = [
    {
        "prompt": "Create a file at ~/greeting.txt containing exactly the text: Hello from Rhemify",
        "verify_path": "~/greeting.txt",
        "expected_content": "Hello from Rhemify",
    },
    {
...
class TerminalTestEnv(RhemifyAgentBaseEnv):
    ...
    def config_init(cls) -> Tuple[TerminalTestEnvConfig, List[APIServerConfig]]:
        ...
        Claude for inference. API keys loaded from ~/rhemify/.env.
        """
