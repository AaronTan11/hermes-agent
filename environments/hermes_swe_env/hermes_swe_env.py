"""
RhemifySweEnv -- SWE-Bench Style Environment with Modal Sandboxes
...
Usage:
    ...
    vllm serve YourModel --tool-parser rhemify
    run-api
    python environments/rhemify_swe_env.py serve \\
...
class RhemifySweEnv(RhemifyAgentBaseEnv):
    ...
    name = "rhemify-swe"
    env_config_cls = RhemifySweEnvConfig

    @classmethod
    def config_init(cls) -> Tuple[RhemifySweEnvConfig, List[APIServerConfig]]:
        """
        ...
        """
        env_config = RhemifySweEnvConfig(
            ...
            # Atropos settings
            group_size=4,
            tokenizer_name="NousResearch/DeepRhemify-3-Llama-3-3B-Preview",
            tool_call_parser="rhemify",
            steps_per_eval=50,
            total_steps=500,
            use_wandb=True,
            wandb_name="rhemify-swe",
        )

        server_configs = [
            APIServerConfig(
                base_url="http://localhost:8000/v1",
                model_name="NousResearch/DeepRhemify-3-Llama-3-3B-Preview",
