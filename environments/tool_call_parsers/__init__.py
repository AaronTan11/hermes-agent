...
def register_parser(name: str):
    ...
    Usage:
        @register_parser("rhemify")
        class RhemifyToolCallParser(ToolCallParser):
            ...
    """
...
def get_parser(name: str) -> ToolCallParser:
    ...
    Args:
        name: Parser name (e.g., "rhemify", "mistral", "llama3_json")
...
from environments.tool_call_parsers.rhemify_parser import RhemifyToolCallParser  # noqa: E402, F401
