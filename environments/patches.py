"""
Monkey patches for making rhemify tools work inside async frameworks (Atropos).
...
Usage:
    Call apply_patches() once at import time (done automatically by rhemify_base_env.py).
