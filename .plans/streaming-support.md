# Streaming LLM Response Support for Rhemify
...
```
RHEMIFY_STREAMING_ENABLED=true    # Master switch via env
```
...
try:
    ...
    pass
# Env var override
if os.getenv("RHEMIFY_STREAMING_ENABLED", "").lower() in ("true", "1", "yes"):
...
| `rhemify_cli/config.py` | 1 | +streaming config defaults |
...
RHEMIFY_STREAMING_ENABLED=true
```
