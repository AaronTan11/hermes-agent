...
class MemoryProvider(ABC):
    ...
    def initialize(self, session_id: str, **kwargs) -> None:
        ...
        kwargs always include:
          - rhemify_home (str): The active RHEMIFY_HOME directory path. Use this
            for profile-scoped storage instead of hardcoding ``~/.rhemify``.
        ...
        kwargs may also include:
          ...
          - agent_workspace (str): Shared workspace name (e.g. "rhemify").
    ...
    def get_config_schema(self) -> List[Dict[str, Any]]:
        ...
        Used by 'rhemify memory setup' to walk the user through configuration.
    ...
    def save_config(self, values: Dict[str, Any], rhemify_home: str) -> None:
        """Write non-secret config to the provider's native location.

        Called by 'rhemify memory setup' after collecting user inputs.
        ``values`` contains only non-secret fields (secrets go to .env).
        ``rhemify_home`` is the active RHEMIFY_HOME directory path.
