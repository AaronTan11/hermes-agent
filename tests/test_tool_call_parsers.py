...
class TestParserRegistry:
    ...
    def test_rhemify_parser_registered(self):
        parsers = list_parsers()
        assert "rhemify" in parsers
...
# ─── Rhemify parser tests ────────────────────────────────────────────────

class TestRhemifyParser:
    @pytest.fixture
    def parser(self):
        return get_parser("rhemify")
...
class TestParseResultContract:
    ...
    @pytest.fixture(params=["rhemify"])  # Add more as needed
    ...
    def test_tool_calls_are_proper_objects(self, parser):
        ...
        # Use rhemify format since that's universal
