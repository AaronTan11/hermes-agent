...
import rhemify_cli.doctor as doctor
import rhemify_cli.gateway as gateway_cli
from rhemify_cli import doctor as doctor_mod
from rhemify_cli.doctor import _has_provider_env_config
...
def test_run_doctor_sets_interactive_env_for_tool_checks(monkeypatch, tmp_path):
    ...
    monkeypatch.setattr(doctor_mod, "RHEMIFY_HOME", rhemify_home)
    monkeypatch.delenv("RHEMIFY_INTERACTIVE", raising=False)

    seen = {}

    def fake_check_tool_availability(*args, **kwargs):
        seen["interactive"] = os.getenv("RHEMIFY_INTERACTIVE")
        raise SystemExit(0)
