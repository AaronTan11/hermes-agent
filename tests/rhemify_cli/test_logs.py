"""Tests for rhemify_cli/logs.py — log viewing and filtering."""
...
def log_dir(tmp_path, monkeypatch):
    """Create a fake RHEMIFY_HOME with a logs/ directory."""
    home = Path(os.environ["RHEMIFY_HOME"])
    logs = home / "logs"
