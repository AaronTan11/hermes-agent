"""Tests for the interactive session browser (`rhemify sessions browse`).
...
from rhemify_cli.main import _session_browse_picker
...
class TestSessionBrowseArgparse:
    ...
    def test_browse_subcommand_exists(self):
        """rhemify sessions browse should be parseable."""
        from rhemify_cli.main import main as _main_entry
