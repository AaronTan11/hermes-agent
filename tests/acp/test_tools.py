...
COMMON_RHEMIFY_TOOLS = ["read_file", "search_files", "terminal", "patch", "write_file", "process"]


class TestToolKindMap:
    def test_all_rhemify_tools_have_kind(self):
        """Every common rhemify tool should appear in TOOL_KIND_MAP."""
        for tool in COMMON_RHEMIFY_TOOLS:
