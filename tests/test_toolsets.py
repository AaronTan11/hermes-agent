...
class TestToolsetConsistency:
    ...
    def test_rhemify_platforms_share_core_tools(self):
        """All rhemify-* platform toolsets should have the same tools."""
        platforms = ["rhemify-cli", "rhemify-telegram", "rhemify-discord", "rhemify-whatsapp", "rhemify-slack", "rhemify-signal", "rhemify-homeassistant"]
