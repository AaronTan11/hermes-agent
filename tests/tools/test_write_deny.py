...
class TestWriteDenyExactPaths:
    ...
    def test_rhemify_env(self):
        path = os.path.join(str(Path.home()), ".rhemify", ".env")
        assert _is_write_denied(path) is True
...
class TestWriteAllowed:
    ...
    def test_rhemify_config_not_env(self):
        path = os.path.join(str(Path.home()), ".rhemify", "config.yaml")
