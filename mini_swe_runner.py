#!/usr/bin/env python3
"""
SWE Runner with Rhemify Trajectory Format

A runner that uses Rhemify-Agent's built-in execution environments
(local, docker, modal) and outputs trajectories in the Rhemify-Agent format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses Rhemify-Agent's Docker, Modal, or Local environments for command execution
- Outputs trajectories in Rhemify format (from/value pairs with <tool_call>/<tool_response> XML)
...
# ============================================================================
# Terminal Tool Definition (matches Rhemify-Agent format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using Rhemify-Agent's built-in backends.
...
# ============================================================================
# Mini-SWE Runner with Rhemify Trajectory Format
# ============================================================================

class MiniSWERunner:
    """
    Agent runner that uses Rhemify-Agent's built-in execution environments
    and outputs trajectories in Rhemify-Agent format.
    """
    ...
    def _convert_to_rhemify_format(
        self,
        ...
        """
        Convert internal message format to Rhemify trajectory format.
...
Complete the user's task step by step."""
        ...
        # Convert to Rhemify trajectory format
        trajectory = self._convert_to_rhemify_format(messages, task, completed)
...
def main(
    ...
    """
    Run SWE tasks with Rhemify trajectory format output.
    ...
    """
    print("🚀 Mini-SWE Runner with Rhemify Trajectory Format")
    print("=" * 60)
