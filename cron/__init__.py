"""
Cron job scheduling system for Rhemify.
...
Cron jobs are executed automatically by the gateway daemon:
    rhemify gateway install    # Install as a user service
    sudo rhemify gateway install --system  # Linux servers: boot-time system service
    rhemify gateway            # Or run in foreground
