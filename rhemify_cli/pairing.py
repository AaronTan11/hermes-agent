...
Usage:
    rhemify pairing list              # Show all pending + approved users
    rhemify pairing approve <platform> <code>  # Approve a pairing code
    rhemify pairing revoke <platform> <user_id> # Revoke user access
    rhemify pairing clear-pending     # Clear all expired/pending codes
"""

def pairing_command(args):
    """Handle rhemify pairing subcommands."""
    ...
    if action == "list":
        ...
        print("Usage: rhemify pairing {list|approve|revoke|clear-pending}")
        print("Run 'rhemify pairing --help' for details.")
...
def _cmd_approve(store, platform: str, code: str):
    ...
    if result:
        ...
        print("  Run 'rhemify pairing list' to see pending codes.\n")
