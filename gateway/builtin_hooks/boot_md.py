"""Built-in boot-md hook — run ~/.rhemify/BOOT.md on gateway startup.

This hook is always registered. It silently skips if no BOOT.md exists.
To activate, create ``~/.rhemify/BOOT.md`` with instructions for the
...
BOOT_FILE = RHEMIFY_HOME / "BOOT.md"
