"""
Email platform adapter for the Rhemify gateway.

Allows users to interact with Rhemify by sending emails.
...
class EmailAdapter(BasePlatformAdapter):
    ...
    def _send_email(
        ...
        subject = ctx.get("subject", "Rhemify")
        ...
        msg_id = f"<rhemify-{uuid.uuid4().hex[:12]}@{self._address.split('@')[1]}>"
